...
class Decision_Stump:
    ...
    def decide_rootnode(self,number_of_attributes):
        ...
        for index in range(number_of_attributes):
            true_count_en[index] = self.dataframe[(self.dataframe[attribute[index]] == 'True') &
                                                  (self.dataframe['class'] == 'en')].loc[:,'weight'].sum()
            true_count_nl[index] = self.dataframe[(self.dataframe[attribute[index]] == 'True') &
                                                  (self.dataframe['class'] == 'nl')].loc[:,'weight'].sum()
            false_count_en[index] = self.dataframe[(self.dataframe[attribute[index]] == 'False') &
                                                   (self.dataframe['class'] == 'en')].loc[:,'weight'].sum()
            false_count_nl[index] = self.dataframe[(self.dataframe[attribute[index]] == 'False') &
                                                   (self.dataframe['class'] == 'nl')].loc[:,'weight'].sum()
    ...
    def readFile(self):
        ...
        while line and len(line)>1:
            ...
            dictionary = {'attribute1':[attribute1], 'attribute2':[attribute2], 'attribute3':[attribute3],
                          'attribute4': [attribute4], 'attribute5':[attribute5], 'attribute6':[attribute6], 'class':[get_class[0]],
                          'attribute7': [attribute7],'attribute9':[attribute9],'attribute8':[attribute8],'attribute10':[attribute10]}
